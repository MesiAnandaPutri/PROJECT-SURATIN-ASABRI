<x-app-layout>
    <div class="mb-6">
        <h2 class="text-2xl font-bold text-gray-800">Tambah Berkas Baru</h2>
        <p class="text-gray-600">Formulir pencatatan surat masuk.</p>
    </div>

    <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
        <form action="{{ route('surat-masuk.store') }}" method="POST" enctype="multipart/form-data" class="p-8">
            @csrf
            ...
            <div class="grid grid-cols-12 gap-6">
                ...
                <!-- Pengirim -->
                <div class="col-span-12 md:col-span-4 flex items-center">
                    <label class="block text-sm font-bold text-asabri-blue uppercase tracking-wide">Pengirim</label>
                </div>
                <div class="col-span-12 md:col-span-8">
